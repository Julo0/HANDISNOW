...
% The difference is in the input : the frame for the backside and frontside
% can be calculated like the users want


function cycle_data = Cycle_data_determination3(Struct, fbs, ffs)
